...
########################################################################
        ...
        if self.titulo_nueva_ventana:
            ...
            for fila in range(3):
                for columna in range(4):
                    boton_nueva_ventana = QPushButton(f' {fila * 4 + columna + 1}', self.nueva_ventana)
                    ...
                    self.botones_pagina1.append(boton_nueva_ventana)  # Agregar botones a la lista
    ...
    def actualizar_pagina2(self):
        ...
        # Aquí puedes agregar lógica para mostrar los botones de la página 2
        # ...
